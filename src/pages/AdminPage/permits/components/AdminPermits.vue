...
import { TypographyH1, TypographyH3, TypographySmall } from '@/components/ui/typography'
import {
  Search,
  Pencil,
  Eye,
...
import {
  ...
  statusOptions,
  statusCardColors,
  statusCardLabelColors,
  statusCardCountColors,
  statusCardIcons,
  getDaysAgo,
            ...
            <div class="flex items-center justify-between">
              <CardTitle
                :class="[
                  ...
                  statusCardLabelColors[status],
                ]"
              >
                {{ formatStatus(status) }}
              </CardTitle>
              <component
                :is="statusCardIcons[status]"
                :class="['w-4 h-4', statusCardLabelColors[status]]"
              />
            </div>
          </CardHeader>
          <CardContent class="px-4 pb-4">
            <div :class="['text-3xl font-bold', statusCardCountColors[status]]">
              {{ statusStats[status] }}
            </div>
          </CardContent>
        </Card>
